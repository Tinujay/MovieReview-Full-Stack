...
function EditForm(props) {
  ...
  return (
    <Def>
      <main className="editpage" style={{backgroundImage: "url(/images/movies.jpg)", height: "100vh", width: "100vw", backgroundSize: "cover", backgroundPosition: "center"}} >
          <h1>Edit Movie:</h1>
          <form className="edit-form" method="POST" action={`/movies/${movie._id}?_method=PUT`}>
